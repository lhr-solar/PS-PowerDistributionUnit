// Test_CAN.c
// ----------------------------------------------------------------------------
// Transmits CAN status message with output channel state, current 
// measurements. 
...
TaskHandle_t task_cansendstatus;
...
int main()
{
    ...
    task_cansendstatus = xTaskCreateStatic(Task_CanSendStatus,
    ...
    vTaskSuspend(task_cansendstatus);
    vTaskStartScheduler();
...
void PDU_Mk1_StartTasks()
{
    ...
    vTaskResume(task_cansendstatus);
}
