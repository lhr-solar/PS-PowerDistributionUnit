...
def compile_test(script_dir: Path, port: str, test_name: str,
    ...
    build_dir = script_dir.parent / "TestBoard_TPS27SA08-Q1/autobuild" / port / test_name
...
def main():
    ...
    tests_dir = Path("firmware/TestBoard_TPS27SA08-Q1/test/src")
    tests = find_tests(git_dir / tests_dir)

    makefile_dir = Path("firmware/TestBoard_TPS27SA08-Q1")
