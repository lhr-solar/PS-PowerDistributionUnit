...
#define MCP23S17_CONFIG_INTMIRROR_DEFAULT MCP23S17_CONFIG_INT_SEPARATE

// INT Pins Operating Mode
typedef enum {
	MCP23S17_CONFIG_INTDRIVE_PP,		// INT pins are push-pull.
	MCP23S17_CONFIG_INTDRIVE_OD,		// INT pins are open-drain.
} MCP23S17_Config_IntDrive_t;
#define MCP23S17_CONFIG_INTDRIVE_DEFAULT MCP23S17_CONFIG_INTDRIVE_PP

// INT Pins Polarity (only applicable if configured as push-pull)
typedef enum {
	MCP23S17_CONFIG_INTPOL_ACTIVE_LOW,		// INT pins are active low.
	MCP23S17_CONFIG_INTPOL_ACTIVE_HIGH,		// INT pins are active high.
} MCP23S17_Config_IntPol_t;
#define MCP23S17_CONFIG_INTPOL_DEFAULT MCP23S17_CONFIG_INTPOL_ACTIVE_LOW
...
#define MCP23S17_PULLUP_DEFAULT MCP23S17_PULLUP_DISABLED
...
typedef enum {
	MCP23S17_INTEN_DISABLED,		// Interrupts disabled on GPIO pin.
	MCP23S17_INTEN_ENABLED,			// Interrupts enabled on GPIO pin.
} MCP23S17_InterruptEnable_t;
#define MCP23S17_INTEN_DEFAULT MCP23S17_INTEN_DISABLED

typedef enum {
	MCP23S17_INTMODE_ON_CHANGE,			// Interrupt occurs on pin state change.
	MCP23S17_INTMODE_DEFVAL_COMPARE,	// Interrupt occurs on deviation from default pin state.
										// Default pin state is set in DEFVAL register.
} MCP23S17_InterruptMode_t;
#define MCP23S17_INTMODE_DEFAULT MCP23S17_INTMODE_ON_CHANGE
